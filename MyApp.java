...
public class MyApp extends JFrame implements KeyListener {
	...
	***************************************************************************************************/
	private int PerspectiveProjection_X(My3D point_camera_space) {
		//transform x-coord to [-1,1] in clipping-space
		
		//if n==-1 and r==+1 and (left)l==-1
		//then x' == (Px/Pz)

        double clip_space_X = point_camera_space.x / point_camera_space.z;	

		//now clip_space_X is between -1 and +1, convert to java swing-gui user-coords space 
		int temp = Convert_To_UserCoord_X(clip_space_X);
		return temp;
	}//PerspectiveProjection_X
	
	
	private int PerspectiveProjection_Y(My3D point_camera_space) {
		//transform y-coord to [-1,1] in clipping-space
		
		//if n==-1 and t==+1 and b==-1
		//then y' == (Py/Pz)
		
		double clip_space_Y = point_camera_space.y / point_camera_space.z;
		
		//now clip_space_Y is between -1 and +1, convert to java swing-gui user-coords space
		int temp = Convert_To_UserCoord_Y(clip_space_Y);
		return temp;
	}//PerspectiveProjection_Y
   ...
   for now hard-code alpha to be 90 degrees
   tan(45 degrees) == 1
   e == 1


   Projection-X == -1 * (e/Z)(X)
   Projection-Y == -1 * (e/Z)(Y)
   ***********************************************/
   private double ProjectionX(My3D point) {
       double e = 1;
       double answer = (e * point.x) / point.z;
       return answer;
   }

   private double ProjectionY(My3D point) {
       double e = 1;
       double answer = (e * point.y) / point.z;
       return answer;
   }
   ...
   ******************************************/
   ...
   private void DoOrthogonalProjectionDrawObject(Graphics2D g2)
   {
	        if (side1_normal_vector.z > 0) {
				int [] side1_x = { Convert_To_UserCoord_X(side1_vertex1.x), Convert_To_UserCoord_X(side1_vertex2.x), Convert_To_UserCoord_X(side1_vertex3.x), Convert_To_UserCoord_X(side1_vertex4.x) };
				int [] side1_y = { Convert_To_UserCoord_Y(side1_vertex1.y), Convert_To_UserCoord_Y(side1_vertex2.y), Convert_To_UserCoord_Y(side1_vertex3.y), Convert_To_UserCoord_Y(side1_vertex4.y) };
				g2.setPaint(fg);
			...
			if (side2_normal_vector.z > 0) {
				int [] side2_x = { Convert_To_UserCoord_X(side2_vertex1.x), Convert_To_UserCoord_X(side2_vertex2.x), Convert_To_UserCoord_X(side2_vertex3.x), Convert_To_UserCoord_X(side2_vertex4.x) };
				int [] side2_y = { Convert_To_UserCoord_Y(side2_vertex1.y), Convert_To_UserCoord_Y(side2_vertex2.y), Convert_To_UserCoord_Y(side2_vertex3.y), Convert_To_UserCoord_Y(side2_vertex4.y) };
				g2.setPaint(fg);
			...
			if (side3_normal_vector.z > 0) {
				int [] side3_x = { Convert_To_UserCoord_X(side3_vertex1.x), Convert_To_UserCoord_X(side3_vertex2.x), Convert_To_UserCoord_X(side3_vertex3.x), Convert_To_UserCoord_X(side3_vertex4.x) };
				int [] side3_y = { Convert_To_UserCoord_Y(side3_vertex1.y), Convert_To_UserCoord_Y(side3_vertex2.y), Convert_To_UserCoord_Y(side3_vertex3.y), Convert_To_UserCoord_Y(side3_vertex4.y) };
				g2.setPaint(fg);
			...
			if (side4_normal_vector.z > 0) {
				int [] side4_x = { Convert_To_UserCoord_X(side4_vertex1.x), Convert_To_UserCoord_X(side4_vertex2.x), Convert_To_UserCoord_X(side4_vertex3.x), Convert_To_UserCoord_X(side4_vertex4.x) };
				int [] side4_y = { Convert_To_UserCoord_Y(side4_vertex1.y), Convert_To_UserCoord_Y(side4_vertex2.y), Convert_To_UserCoord_Y(side4_vertex3.y), Convert_To_UserCoord_Y(side4_vertex4.y) };
				g2.setPaint(fg);
			...
			if (side5_normal_vector.z > 0) {
				int [] side5_x = { Convert_To_UserCoord_X(side5_vertex1.x), Convert_To_UserCoord_X(side5_vertex2.x), Convert_To_UserCoord_X(side5_vertex3.x), Convert_To_UserCoord_X(side5_vertex4.x) };
				int [] side5_y = { Convert_To_UserCoord_Y(side5_vertex1.y), Convert_To_UserCoord_Y(side5_vertex2.y), Convert_To_UserCoord_Y(side5_vertex3.y), Convert_To_UserCoord_Y(side5_vertex4.y) };
				g2.setPaint(fg);
			...
			if (side6_normal_vector.z > 0) {
				int [] side6_x = { Convert_To_UserCoord_X(side6_vertex1.x), Convert_To_UserCoord_X(side6_vertex2.x), Convert_To_UserCoord_X(side6_vertex3.x), Convert_To_UserCoord_X(side6_vertex4.x) };
				int [] side6_y = { Convert_To_UserCoord_Y(side6_vertex1.y), Convert_To_UserCoord_Y(side6_vertex2.y), Convert_To_UserCoord_Y(side6_vertex3.y), Convert_To_UserCoord_Y(side6_vertex4.y) };
				g2.setPaint(fg);
				g2.drawPolygon(side6_x, side6_y, 4);
				g2.setColor(side6_color);
				g2.fillPolygon(side6_x, side6_y, 4);
			}
   }//DoOrthogonalProjectionDrawObject
   ...
   public void paint(Graphics g) {
		...
		DoOrthogonalProjectionDrawObject(g2);
    }
	...
	private void OrthogonalProjection_RotateCube_X_Axis() {
	...
	}//OrthogonalProjection_RotateCube_X_Axis
	
	
	private void OrthogonalProjection_RotateCube_Y_Axis() {
		  double angle_in_radians = Math.toRadians(15);
	...
	}//OrthogonalProjection_RotateCube_Y_Axis
	
	private void OrthogonalProjection_RotateCube_Z_Axis() {
		double angle_in_radians = Math.toRadians(15);
          ...
          side6_normal_vector.y = side6_norm_pt.y - side6_vertex1.y;
          side6_normal_vector.z = side6_norm_pt.z - side6_vertex1.z;
	}//OrthogonalProjection_RotateCube_Z_Axis
    ...
    private void HandleKeyPress(KeyEvent e) {
       ...
       if (keyCode == 65) { //a
          ...
          //System.out.println("projection side1_vertex1 = " + ProjectionX(side1_vertex1) + " , " + ProjectionY(side1_vertex1));
          //System.out.println("projection side1_vertex2 = " + ProjectionX(side1_vertex2) + " , " + ProjectionY(side1_vertex2));
          //System.out.println("projection side1_vertex3 = " + ProjectionX(side1_vertex3) + " , " + ProjectionY(side1_vertex3));
          //System.out.println("projection side1_vertex4 = " + ProjectionX(side1_vertex4) + " , " + ProjectionY(side1_vertex4));
       }
